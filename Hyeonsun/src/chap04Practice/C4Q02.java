...
public class C4Q02<E> {
	private int max;	//스택 용
	...
	//생성자 
	public C4Q02(Class<E> clazz, int capacity) {
		ptr = 0;
		max = capacity;
		try {
			stk = (E[]) Array.newInstance(clazz, max);		//스택 본체용 배열을 생성 
